...
<nav>
    ...
    <ul>
        ...
        <li><a class="active" href="addphone.php">Add Phone</a></li>
    ...
    <main>
        ...
        <h1 class="buy-now">Add Product</h2>
        <div class="row">
...
<input class="inp" type="text" name="phone_name" id="phone_name" placeholder="Phone Name"><br><br> 

<textarea name="description" id="description" cols="30" rows="5" placeholder="Phone Description"></textarea><br>
<br>
<label for="color">Phone Price:</label>
<input class="inp" type="number" name="price" id="price" placeholder="Phone Price"><br><br>

<!-- <label for="color">Pick a color:</label>
<select name="color" id="color" style="text-align: center;"><br>
        <option value="black">Black</option>
        <option value="white">White</option>
</select><br> -->


<label for="comapny">Select Company:</label><br>
<select class="inp" name="company" id="company" style="text-align: center; font-size:1rem;"><br><br>
